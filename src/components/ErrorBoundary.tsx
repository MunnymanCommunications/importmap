...
export class ErrorBoundary extends Component<Props, State> {
  ...
  // FIX: Explicitly define the constructor and call `super(props)`. 
  // This resolves an issue where TypeScript, possibly due to a misconfiguration 
  // or type conflict, fails to recognize the inherited `props` property.
